...
return [
    ...
    'mail' => [
        'host' => ds_env('MAIL_HOST', 'sandbox.smtp.mailtrap.io'),
        'port' => (int) ds_env('MAIL_PORT', 2525),
        'encryption' => ds_env('MAIL_ENCRYPTION', 'tls'),
        'username' => ds_env('MAIL_USERNAME', ''),
        'password' => ds_env('MAIL_PASSWORD', ''),
        'from_address' => ds_env('MAIL_FROM_ADDRESS', 'noreply@deepshield.fr'),
        'from_name' => ds_env('MAIL_FROM_NAME', 'DeepShield'),
    ],
